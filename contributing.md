...
# Contributing to Mac Admins Open Source Projects

Mac Admins Open Source projects live across a number of repositories under the [`github.com/macadmins`](https://github.com/macadmins) organization. Each project has its own maintainers, goals, constraints, and technical details, but we expect the same basic contribution process across the organization.

We welcome thoughtful contributions, including bug fixes, documentation improvements, tests, new features, and maintenance work. The best contributions usually start with a clear discussion of the problem before code is written.
...
* Changes that alter project defaults or assumptions
